...
/**
 * - For use internally at Katana Perps and may be removed or changed anywhere it is implemented without warning.
 *
 * @internal
 */
export const INTERNAL_SYMBOL = Symbol.for('@katanaPerps/internal');
