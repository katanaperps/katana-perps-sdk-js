...
export class RestAuthenticatedClient {
  ...
  #exchange: null | katanaPerps.KatanaPerpsExchange = null;

  readonly #signer: undefined | katanaPerps.SignTypedData = undefined;
  ...
  public async getMarketMakerRewardsEpoch(
    params: katanaPerps.RestRequestGetMarketMakerRewardsEpochWithWallet,
  ): Promise<katanaPerps.MarketMakerRewardsEpochDetailedWithWallet>;
  /**
   ...
   */
  public async getMarketMakerRewardsEpoch(
    params: katanaPerps.RestRequestGetMarketMakerRewardsEpochWithoutWallet,
  ): Promise<katanaPerps.MarketMakerRewardsEpochDetailedWithoutWallet>;
  public async getMarketMakerRewardsEpoch<
    R extends katanaPerps.RestRequestGetMarketMakerRewardsEpoch,
  >(params: R) {
    return this.get<katanaPerps.RestResponseGetMarketMakerRewardsEpoch<R>>(
  ...
  public async getMarketMakerRewardsEpochs(
    params: katanaPerps.RestRequestGetMarketMakerRewardsEpochs = {},
  ) {
    return this.get<katanaPerps.RestResponseGetMarketMakerRewardsEpochs>(
  ...
  public async associateWallet(
    params: katanaPerps.RestRequestAssociateWallet,
    referralCode?: string,
    ...
    return this.post<katanaPerps.RestResponseAssociateWallet>('/wallets', {
      referralCode,
      parameters: params,
    ...
    } satisfies katanaPerps.RestRequestAssociateWalletSigned);
  }
   ...
   * @category Wallets & Positions
   */
  public async getPositions(params: katanaPerps.RestRequestGetPositions) {
    return this.get<katanaPerps.RestResponseGetPositions>('/positions', params);
  }
   ...
   * @category Orders
   */
  public async getOrder(params: katanaPerps.RestRequestGetOrder) {
    return this.get<katanaPerps.RestResponseGetOrder>('/orders', params);
  }
   ...
   * @category Orders
   */
  public async getOrders(params: katanaPerps.RestRequestGetOrders) {
    return this.get<katanaPerps.RestResponseGetOrders>('/orders', params);
  }
   ...
   */
  public async getFill(params: katanaPerps.RestRequestGetFill) {
    return this.get<katanaPerps.RestResponseGetFill>('/fills', params);
  }
   ...
   * @category Fills & Historical
   */
  public async getFills(params: katanaPerps.RestRequestGetFills) {
    return this.get<katanaPerps.RestResponseGetFills>('/fills', params);
  }
   ...
   * @category Rewards & Payouts
   */
  public async authorizePayout(params: katanaPerps.RestRequestAuthorizePayout) {
    return this.post<katanaPerps.RestResponseAuthorizePayout>(
      '/payouts',
      params,
    );
  }
   ...
   * @category Rewards & Payouts
   */
  public async getPayouts(params: katanaPerps.RestRequestGetPayouts) {
    return this.get<katanaPerps.RestResponseGetPayouts>('/payouts', params);
  }
   ...
   */
  public async getDeposit(params: katanaPerps.RestRequestGetDeposit) {
    return this.get<katanaPerps.RestResponseGetDeposit>('/deposits', params);
  }
   ...
   * @category Deposits & Withdrawals
   */
  public async getDeposits(params: katanaPerps.RestRequestGetDeposits) {
    return this.get<katanaPerps.RestResponseGetDeposits>('/deposits', params);
  }
  ...
  public async withdraw(
    $params:
      | katanaPerps.RestRequestWithdrawFundsSDK
      | katanaPerps.RestRequestWithdrawFunds,
    signer: undefined | katanaPerps.SignTypedData = this.#signer,
  ) {
    ensureSigner(signer);
    ...
    return this.post<katanaPerps.RestResponseWithdrawFunds>('/withdrawals', {
      parameters: params,
      signature: await signer(
        ...getWithdrawalSignatureTypedData(
          params,
   ...
   * @category Deposits & Withdrawals
   */
  public async getWithdrawal(params: katanaPerps.RestRequestGetWithdrawal) {
    return this.get<katanaPerps.RestResponseGetWithdrawal>(
      '/withdrawals',
      params,
    );
  }
   ...
   * @category Deposits & Withdrawals
   */
  public async getWithdrawals(params: katanaPerps.RestRequestGetWithdrawals) {
    return this.get<katanaPerps.RestResponseGetWithdrawals>(
      '/withdrawals',
      params,
    );
  }
  ...
  public async getFundingPayments<
    R = katanaPerps.RestResponseGetFundingPayments,
  >(params: katanaPerps.RestRequestGetFundingPayments) {
  ...
  public async getInitialMarginFractionOverride<
    R = katanaPerps.RestResponseGetInitialMarginFractionOverride,
  >(params: katanaPerps.RestRequestGetInitialMarginFractionOverride) {
   ...
   * @category Fills & Historical
   */
  public async getHistoricalPnL(
    params: katanaPerps.RestRequestGetHistoricalPnL,
  ) {
    return this.get<katanaPerps.RestResponseGetHistoricalPnL>(
      '/historicalPnL',
      params,
    );
  }
   ...
   * @category WebSocket
   */
  public async getWsToken(
    params: katanaPerps.RestRequestGetAuthenticationToken,
  ) {
    ...
    return (
      await this.get<katanaPerps.RestResponseGetAuthenticationToken>(
        '/wsToken',
        params,
      )
    ).token;
  ...
  public readonly [INTERNAL_SYMBOL] = Object.freeze({
    ...
    getFundingPayments: async (
      ...
      const result = await this.getFundingPayments<
        Paginated<katanaPerps.RestResponseGetFundingPayments>
      >(
        {
          ...params,
    ...
    getXChallenge: async (
      ...
      const result =
        await this.get<katanaPerps.RestResponseGetVaultXConnectionChallenge>(
          '/internal/vaults/xchallenge',
          params,
        );
    ...
    placeConditionalTpSlOrder: async <
      T extends
        | typeof katanaPerps.OrderType.takeProfitMarket
        | typeof katanaPerps.OrderType.stopLossMarket,
    >(
      ...
      return this.post<katanaPerps.RestResponseGetOrder & { type: T }>(
        '/internal/orders/conditionalTpSlOrders',
        {
          ...
          order: katanaPerps.RestRequestCreateOrderSigned;
          conditionalParentOrderPublicId: string;
        },
      );
    },

    placeOrderWithConditionalTpSlOrders: async <
      T extends katanaPerps.OrderType,
    >(
      params: {
        order: katanaPerps.RestRequestOrder & { type: T };
        conditionalTakeProfitOrder?: katanaPerps.RestRequestOrder & {
          type: typeof katanaPerps.OrderType.takeProfitMarket;
        };
        conditionalStopLossOrder?: katanaPerps.RestRequestOrder & {
      ...
      conditionalStopLossOrder?: katanaPerps.RestResponseGetOrder & {
        type: typeof katanaPerps.OrderType.stopLossMarket;
      };
    }> => {
      ensureSigner(signer);
      ...
      return this.post<{
        ...
        order: katanaPerps.RestRequestCreateOrderSigned;
        conditionalTakeProfitOrder?: katanaPerps.RestRequestCreateOrderSigned;
        conditionalStopLossOrder?: katanaPerps.RestRequestCreateOrderSigned;
      });
    },

    setVaultDetails: async (
      params: katanaPerps.RestRequestSetVaultDetails,
      signer: undefined | katanaPerps.SignTypedData = this.#signer,
    ) => {
      ensureSigner(signer);
      ...
      return this.post<katanaPerps.RestResponseSetVaultDetails>(
        '/internal/vaults/details',
        {
          parameters: params,
          signature: await signer(
            ...getSetVaultDetailsSignatureTypedData(
    ...
    setVaultXConnection: async (
      params: katanaPerps.RestRequestSetVaultXConnection,
      signer: undefined | katanaPerps.SignTypedData = this.#signer,
    ) => {
      ensureSigner(signer);
    ...
    withdrawFromManagedAccountByQuantity: async (
      $params:
        | katanaPerps.RestRequestWithdrawFundsFromManagedAccountByQuantitySDK
        | katanaPerps.RestRequestWithdrawFundsFromManagedAccountByQuantity,
      signer: undefined | katanaPerps.SignTypedData = this.#signer,
    ) => {
      ensureSigner(signer);
      ...
      return this.post<katanaPerps.RestResponseWithdrawFundsFromManagedAccountByQuantity>(
        '/internal/vaults/withdrawByQuantity',
        {
          parameters: params,
          signature: await signer(
            ...getWithdrawalFromManagedAccountByQuantitySignatureTypedData(
    ...
    withdrawFromManagedAccountByShares: async (
      $params:
        | katanaPerps.RestRequestWithdrawFundsFromManagedAccountBySharesSDK
        | katanaPerps.RestRequestWithdrawFundsFromManagedAccountByShares,
      signer: undefined | katanaPerps.SignTypedData = this.#signer,
    ) => {
      ensureSigner(signer);
      ...
      return this.post<katanaPerps.RestResponseWithdrawFundsFromManagedAccountByShares>(
        '/internal/vaults/withdrawByShares',
        {
          parameters: params,
          signature: await signer(
            ...getWithdrawalFromManagedAccountBySharesSignatureTypedData(
...
function ensureSigner(
  signer: katanaPerps.SignTypedData | undefined,
): asserts signer is katanaPerps.SignTypedData {
  if (!signer) {
    throw new Error(
