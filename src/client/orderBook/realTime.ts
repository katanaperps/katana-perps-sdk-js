...
import type { KatanaPerpsMessageEvent } from '#types/webSocket/request/subscriptions';
import type { ErrorEvent } from 'ws';

/**
 * Orderbook Client Options
 *
 * @see typedoc  [Reference Documentation](https://sdk-js-docs-v1-perps.katana.network/classes/OrderBookRealTimeClient.html)
 */
export interface OrderBookRealTimeClientOptions {
  ...
  sandbox?: boolean;
  /**
   * Optionally provide a custom url to use when making Katana Perps REST API requests.
   *
   ...
   * the Katana Perps WebSocket API.
   *
   * - Will override the {@link sandbox} option when given.
   */
  baseWebSocketURL?: string;
  marketsResponse?: katanaPerps.RestResponseGetMarkets;
}
 ...
 *
 * const LIMIT = 10;
 * const MARKETS: MarketSymbol[] = ['BTC-USD'];
 *
...
export class OrderBookRealTimeClient extends EventEmitter<{
  ...
  private readonly l1OrderBooks: Map<string, katanaPerps.L1OrderBook> =
    new Map();

  private readonly l2OrderBooks: Map<string, katanaPerps.L2OrderBook> =
    new Map();

  private readonly l2OrderBookUpdates = new Map<
    string,
    katanaPerps.L2OrderBook[]
  >();
  ...
  private marketsResponse: katanaPerps.RestResponseGetMarkets | undefined =
    undefined;
   ...
   *
   * @see typedoc  [Reference Documentation](https://sdk-js-docs-v1-perps.katana.network/classes/OrderBookRealTimeClient.html#start)
   *
   ...
   *
   * @see typedoc  [Reference Documentation](https://sdk-js-docs-v1-perps.katana.network/classes/OrderBookRealTimeClient.html#stop)
   *
   * @category Connection Management
   */
  public stop() {
   ...
   *
   * @see typedoc  [Reference Documentation](https://sdk-js-docs-v1-perps.katana.network/classes/OrderBookRealTimeClient.html#getOrderBookL1)
   ...
   *   Minimum price movement expressed in pips (10^-8), defaults to market setting
   *
   * @see typedoc  [Reference Documentation](https://sdk-js-docs-v1-perps.katana.network/classes/OrderBookRealTimeClient.html#getOrderBookL2)
  ...
  private async getOrderBooks(
    market: string,
    tickSize?: bigint | undefined,
  ): Promise<{ l1: katanaPerps.L1OrderBook; l2: katanaPerps.L2OrderBook }> {
  ...
  private async webSocketHandleResponse(response: KatanaPerpsMessageEvent) {
