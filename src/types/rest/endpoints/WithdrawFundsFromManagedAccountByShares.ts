 ...
 *   parameter.
 *
 * @see docs    [API Documentation](https://api-docs-v1-perps.katana.network/#withdraw-funds)
 * @see enum    {@link BridgeTarget}
 * @see related {@link RestRequestWithdrawFundsFromManagedAccountByShares}
 *
 ...
 *
 * @see docs    [API Documentation](https://api-docs-v1-perps.katana.network/#withdraw-funds-from-managed-account)
 * @see related {@link RestRequestWithdrawFundsFromManagedAccountBySharesSDK}
 *
 * @category KatanaPerps - Withdraw Funds
 */
