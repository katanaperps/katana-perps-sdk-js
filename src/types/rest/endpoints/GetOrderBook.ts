...
export interface RestRequestGetOrderBookLevel1 extends GetOrderBookBase {
  /**
   * - Not required & ignored when using the Katana Perps SDK, and is already defaulted
...
export interface RestRequestGetOrderBookLevel2
  ...
  /**
   * - Not required & ignored when using the Katana Perps SDK, but required when using the REST API directly
 ...
 */
export interface KatanaPerpsOrderBook {
  /**
 ...
 *
 * @see [API Documentation](https://api-docs-v1-perps.katana.network/#get-order-books)
 * @see related {@link OrderBookPriceLevel} (bids/asks)
 * @see type {@link KatanaPerpsOrderBook}
 * @see level 1 - request  - {@link RestRequestGetOrderBookLevel1}
 * @see level 1 - response - {@link RestResponseGetOrderBookLevel1}
 * @see level 2 - request  - {@link RestRequestGetOrderBookLevel2}
 * @see level 2 - response - {@link RestResponseGetOrderBookLevel2}
 ...
 * @category KatanaPerps - Get OrderBook
 */
export interface RestResponseGetOrderBookLevel1 extends KatanaPerpsOrderBook {
  /**
 ...
 * @category KatanaPerps - Get OrderBook
 */
export interface RestResponseGetOrderBookLevel2 extends KatanaPerpsOrderBook {
  /**
   * - Level-2 order book data includes price and quantity information for all price levels in the order book.
   * @inheritDoc
   */
