 ...
 * @see type {@link KatanaPerpsTicker}
 *
...
/**
 * Katana Perps Ticker Response
 *
 * Response to `GET /v1/tickers`
 *
 * @see docs     [API Documentation: Get Tickers](https://api-docs-v1-perps.katana.network/#get-tickers)
 * @see response {@link RestResponseGetTickers}
 ...
 */
export interface KatanaPerpsTicker {
  /** Market symbol */
  market: string;
  /**
 ...
 * @category KatanaPerps - Get Tickers
 */
export type RestResponseGetTickers = KatanaPerpsTicker[];
