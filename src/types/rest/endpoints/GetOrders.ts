...
export interface KatanaPerpsOrder {
   ...
   *
   * @see [API Documentation](https://api-docs-v1-perps.katana.network/#self-trade-prevention)
...
type ConditionalOrdersMixin = {
  conditionalTakeProfitOrder?: KatanaPerpsOrder & {
    type: typeof OrderType.takeProfitMarket;
  };
  conditionalStopLossOrder?: KatanaPerpsOrder & {
    type: typeof OrderType.stopLossMarket;
  };
};

/**
 * @see type {@link KatanaPerpsOrder}
 * @category KatanaPerps - Get Orders
 */
export type RestResponseGetOrder = KatanaPerpsOrder & ConditionalOrdersMixin;

/**
 * @see type {@link KatanaPerpsOrder}
 * @category KatanaPerps - Get Orders
 */
export type RestResponseGetOrders = (KatanaPerpsOrder &
  ConditionalOrdersMixin)[];
