...
interface RestRequestCancelOrdersBase
   ...
   *   - You may provide an orders {@link katanaPerps.KatanaPerpsOrder.orderId orderId}
   *   - You may provide an orders {@link katanaPerps.KatanaPerpsOrder.clientOrderId clientOrderId}
 ...
 * @category KatanaPerps - Cancel Order
 */
export interface KatanaPerpsCanceledOrder {
  /**
   ...
   */
  status: Extract<katanaPerps.OrderStatus, 'canceled' | 'notFound'>;
}

/**
 * @see type {@link KatanaPerpsCanceledOrder}
 *
 * @category KatanaPerps - Cancel Order
 */
export type RestResponseCancelOrders = KatanaPerpsCanceledOrder[];
