 ...
 * @category KatanaPerps - Set or clear Initial Margin Fraction override
 *
 * @hidden
 */
 ...
 *
 * @category KatanaPerps - Set Initial Margin Fraction override
 ...
 *
 */
export interface KatanaPerpsInitialMarginFractionOverride {
  /**
   * Wallet address
   */
  wallet: string;
 ...
 *
 * @category KatanaPerps - Set initial margin fraction
 *
 * @hidden
 */
