 ...
 * @category Base Types
 */
export interface KatanaPerpsEventBase {
  /**
   * The type property is used to determine the shape of the data property of the update event.
   *
   * - Subscription update events will match {@link KatanaPerpsSubscriptionEventBase} with the subscription
   *   name as the value for the {@link KatanaPerpsSubscriptionEventBase.type type} property.
 ...
 * @category Base Types
 */
export interface KatanaPerpsSubscriptionEventBase extends KatanaPerpsEventBase {
  /**
   * @inheritDoc
   */
  type: Extract<
    KatanaPerpsEventBase['type'],
