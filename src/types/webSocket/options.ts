...
import type {
  KatanaPerpsSubscribeTypeAuthenticated as _WebSocketSubscribeAuthenticatedType,
  KatanaPerpsSubscribeTypePublic as _WebSocketSubscribePublicType,
 ...
 * @example
 * ```typescript
 *   import { WebSocketClient } from '@katanaperps/katana-perps-sdk-ma'
 *
...
export interface WebSocketClientAuthOptions {
   ...
   * this is used to retrieve a [WebSocket Token](https://api-docs-v1-perps.katana.network/#websocket-authentication-endpoints)
   * that can be used to authenticate the connection.
   *
   * @see [WebSocket Token API Docs](https://api-docs-v1-perps.katana.network/#websocket-authentication-endpoints)
   */
  apiKey: string;
  /**
   * Used to compute HMAC signature when refreshing the
   * [WebSocket Token](https://api-docs-v1-perps.katana.network/#websocket-authentication-endpoints)
   *
   * @see [WebSocket Token API Docs](https://api-docs-v1-perps.katana.network/#websocket-authentication-endpoints)
   */
  apiSecret: string;
...
export interface WebSocketClientOptionsBase {
   ...
   * ---
   *
   * - These properties are used to fetch a [WebSocket Token](https://api-docs-v1-perps.katana.network/#websocket-authentication-endpoints)
   *   from the REST API.
   *
   * ---
   *
   ...
   *
   * @see [Sandbox API Documentation](https://api-docs-v1-perps.katana.network/#sandbox)
   *
   * @defaultValue false
   */
  sandbox?: boolean;
   ...
   *
   * @see [WebSocket Connection Maintenance](https://api-docs-v1-perps.katana.network/#connection-maintenance)
   *
   * @defaultValue
   * ```typescript
   * true
   ...
   *
   * @example
   * 'wss://websocket-perps.katana.network/v1'
   */
   ...
   *
   * @example
   *  `https://api-perps.katana.network/v1`
   */
   ...
   * [INTERNAL USE ONLY]
   *
   * @see [WebSocket API Documentation](https://api-docs-v1-perps.katana.network/#websocket-authentication-endpoints)
   *
   * @internal
   */
 ...
 * ---
 *
 * @see docs [WebSocket API Documentation](https://api-docs-v1-perps.katana.network/#subscriptions)
 *
 * @category WebSocket - Client Options
 */
