...
export interface Exchange_v2Interface extends Interface {
  getFunction(
    nameOrSignature:
      ...
      | 'loadBridgeAdapter'
      | 'loadBridgeAdaptersLength'
      | 'loadIndexPriceAdapter'
      | 'loadIndexPriceAdaptersLength'
      | 'loadLastNonceInvalidationForWallet'
      | 'loadManagedAccountProvider'
      | 'loadManagedAccountProvidersLength'
      | 'loadMarket'
      | 'loadMarketsLength'
  ...
  getEvent(
    nameOrSignatureOrTopic:
      ...
      | 'Transferred'
      | 'WalletExitCleared'
      | 'WalletExitFromManagedAccountWithdrawn'
      | 'WalletExitWithdrawn'
      | 'WalletExited'
  ...
  encodeFunctionData(
    functionFragment: 'applyPendingDepositToManagedAccount',
  ...
  encodeFunctionData(
    functionFragment: 'applyPendingWithdrawalFromManagedAccount',
  ...
  encodeFunctionData(
    functionFragment: 'cancelPendingWithdrawalFromManagedAccount',
    values: [WithdrawalFromManagedAccountStruct],
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: 'loadBridgeAdapter',
    values: [BigNumberish],
  ): string;
  encodeFunctionData(
    functionFragment: 'loadBridgeAdaptersLength',
    values?: undefined,
  ): string;
  encodeFunctionData(
    functionFragment: 'loadIndexPriceAdapter',
    values: [BigNumberish],
  ): string;
  encodeFunctionData(
    functionFragment: 'loadIndexPriceAdaptersLength',
    values?: undefined,
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: 'loadManagedAccountProvider',
    values: [BigNumberish],
  ): string;
  encodeFunctionData(
    functionFragment: 'loadManagedAccountProvidersLength',
    values?: undefined,
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: 'setDelegatedKeyExpirationPeriod',
    values: [BigNumberish],
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: 'setManagedAccountProviders',
    values: [AddressLike[]],
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: 'withdrawExitFromManagedAccount',
...
export namespace WalletExitFromManagedAccountWithdrawnEvent {
  export type InputTuple = [
    managerWallet: AddressLike,
    depositorWallet: AddressLike,
    quantity: BigNumberish,
...
export interface Exchange_v2 extends BaseContract {
  ...
  applyPendingDepositToManagedAccount: TypedContractMethod<
    [
  ...
  applyPendingWithdrawalFromManagedAccount: TypedContractMethod<
  ...
  cancelPendingWithdrawalFromManagedAccount: TypedContractMethod<
    [withdrawal: WithdrawalFromManagedAccountStruct],
    [void],
    'nonpayable'
  >;
  ...
  loadIndexPriceAdapter: TypedContractMethod<
    [index: BigNumberish],
    [string],
    'view'
  >;
  ...
  setDelegatedKeyExpirationPeriod: TypedContractMethod<
  ...
  setManagedAccountProviders: TypedContractMethod<
  ...
  >;
  getFunction(
    nameOrSignature: 'applyPendingDepositToManagedAccount',
  ): TypedContractMethod<
    [
      depositIndex_: BigNumberish,
      quantity: BigNumberish,
  ...
  >;
  getFunction(
    nameOrSignature: 'applyPendingWithdrawalFromManagedAccount',
  ): TypedContractMethod<
    [withdrawal: WithdrawalFromManagedAccountStruct],
    [void],
    'nonpayable'
  ...
  getFunction(
    nameOrSignature: 'cancelPendingWithdrawalFromManagedAccount',
  ): TypedContractMethod<
    [withdrawal: WithdrawalFromManagedAccountStruct],
    [void],
    'nonpayable'
  ...
  getFunction(
    nameOrSignature: 'loadBridgeAdapter',
  ): TypedContractMethod<[index: BigNumberish], [string], 'view'>;
  getFunction(
    nameOrSignature: 'loadBridgeAdaptersLength',
  ): TypedContractMethod<[], [bigint], 'view'>;
  getFunction(
    nameOrSignature: 'loadIndexPriceAdapter',
  ): TypedContractMethod<[index: BigNumberish], [string], 'view'>;
  getFunction(
    nameOrSignature: 'loadIndexPriceAdaptersLength',
  ): TypedContractMethod<[], [bigint], 'view'>;
  getFunction(
  ...
  >;
  getFunction(
    nameOrSignature: 'loadManagedAccountProvider',
  ): TypedContractMethod<[index: BigNumberish], [string], 'view'>;
  getFunction(
    nameOrSignature: 'loadManagedAccountProvidersLength',
  ): TypedContractMethod<[], [bigint], 'view'>;
  getFunction(
  ...
  getFunction(
    nameOrSignature: 'setDelegatedKeyExpirationPeriod',
  ): TypedContractMethod<
    [newDelegateKeyExpirationPeriodInMs: BigNumberish],
    [void],
    'nonpayable'
  ...
  >;
  getFunction(
    nameOrSignature: 'setManagedAccountProviders',
  ): TypedContractMethod<
    [newManagedAccountProviders: AddressLike[]],
    [void],
    'nonpayable'
  ...
  getFunction(
    nameOrSignature: 'withdrawExitFromManagedAccount',
  ): TypedContractMethod<
    [
      depositorWallet: AddressLike,
      managerWallet: AddressLike,
  ...
  >;
  getEvent(
    key: 'WalletExitFromManagedAccountWithdrawn',
  ): TypedContractEvent<
    WalletExitFromManagedAccountWithdrawnEvent.InputTuple,
    WalletExitFromManagedAccountWithdrawnEvent.OutputTuple,
    WalletExitFromManagedAccountWithdrawnEvent.OutputObject
  >;
  getEvent(
  ...
  filters: {
    ...
    'WalletExitFromManagedAccountWithdrawn(address,address,uint64)': TypedContractEvent<
      WalletExitFromManagedAccountWithdrawnEvent.InputTuple,
      WalletExitFromManagedAccountWithdrawnEvent.OutputTuple,
      WalletExitFromManagedAccountWithdrawnEvent.OutputObject
    >;
    WalletExitFromManagedAccountWithdrawn: TypedContractEvent<
      WalletExitFromManagedAccountWithdrawnEvent.InputTuple,
      WalletExitFromManagedAccountWithdrawnEvent.OutputTuple,
      WalletExitFromManagedAccountWithdrawnEvent.OutputObject
    >;
    ...
    'WithdrawalFromManagedAccountCanceled(address,uint64,int64)': TypedContractEvent<
      WithdrawalFromManagedAccountCanceledEvent.InputTuple,
      WithdrawalFromManagedAccountCanceledEvent.OutputTuple,
      WithdrawalFromManagedAccountCanceledEvent.OutputObject
    >;
