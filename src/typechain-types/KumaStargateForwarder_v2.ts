...
export interface KumaStargateForwarder_v2Interface extends Interface {
  getFunction(
    nameOrSignature:
      | 'MAX_MULTIPLIER'
      | 'MIN_MULTIPLIER'
  ...
  encodeFunctionData(
    functionFragment: 'setMinimumForwardQuantityMultiplier',
    values: [BigNumberish],
  ): string;
...
export interface KumaStargateForwarder_v2 extends BaseContract {
  connect(runner?: ContractRunner | null): KumaStargateForwarder_v2;
  waitForDeployment(): Promise<this>;

  interface: KumaStargateForwarder_v2Interface;
  ...
  setMinimumForwardQuantityMultiplier: TypedContractMethod<
  ...
  >;
  getFunction(
    nameOrSignature: 'setMinimumForwardQuantityMultiplier',
  ): TypedContractMethod<
    [newMinimumForwardQuantityMultiplier: BigNumberish],
    [void],
    'nonpayable'
