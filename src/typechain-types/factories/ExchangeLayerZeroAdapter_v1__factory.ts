...
const _abi = [
  {
    inputs: [
      {
        internalType: 'uint64',
        name: 'addManagedAccountDepositFeeQuantityInAssetUnits_',
        type: 'uint64',
      },
      {
        internalType: 'uint64',
      ...
      {
        internalType: 'uint64',
        name: 'depositToManagedAccountFeeQuantityInAssetUnits_',
        type: 'uint64',
      },
      {
      ...
      {
        internalType: 'uint64',
        name: 'minimumAddManagedAccountDepositQuantityInAssetUnits_',
        type: 'uint64',
      },
      {
        internalType: 'uint64',
  ...
  {
    inputs: [],
    name: 'MAX_MINIMUM_WITHDRAW_QUANTITY_MULTIPLIER',
    outputs: [
      {
        internalType: 'uint64',
        name: '',
  ...
  {
    inputs: [],
    name: 'MIN_MINIMUM_WITHDRAW_QUANTITY_MULTIPLIER',
    outputs: [
      {
        internalType: 'uint64',
        name: '',
  ...
  {
    inputs: [],
    name: 'addManagedAccountDepositFeeQuantityInAssetUnits',
    outputs: [
      {
        internalType: 'uint64',
        name: '',
  ...
  {
    inputs: [],
    name: 'addManagedAccountManagerWalletNativeDropQuantity',
    outputs: [
      {
        internalType: 'uint64',
        name: '',
  ...
  {
    inputs: [],
    name: 'minimumAddManagedAccountDepositQuantityInAssetUnits',
    outputs: [
      {
        internalType: 'uint64',
        name: '',
  ...
  {
    inputs: [],
    name: 'minimumDepositToManagedAccountQuantityInAssetUnits',
    outputs: [
      {
        internalType: 'uint64',
        name: '',
