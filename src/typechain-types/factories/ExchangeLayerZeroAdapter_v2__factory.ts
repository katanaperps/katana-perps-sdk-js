...
import type {
  ExchangeLayerZeroAdapter_v2,
  ExchangeLayerZeroAdapter_v2Interface,
} from '../ExchangeLayerZeroAdapter_v2';
...
export class ExchangeLayerZeroAdapter_v2__factory {
  static readonly abi = _abi;
  static createInterface(): ExchangeLayerZeroAdapter_v2Interface {
    return new Interface(_abi) as ExchangeLayerZeroAdapter_v2Interface;
  }
  static connect(
    address: string,
    ...
    return new Contract(
      ...
      _abi,
      runner,
    ) as unknown as ExchangeLayerZeroAdapter_v2;
  }
}
