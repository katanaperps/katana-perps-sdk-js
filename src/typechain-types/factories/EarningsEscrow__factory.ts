...
export class EarningsEscrow__factory {
  static readonly abi = _abi;
  static createInterface(): EarningsEscrowInterface {
    return new Interface(_abi) as EarningsEscrowInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null,
  ): EarningsEscrow {
    return new Contract(address, _abi, runner) as unknown as EarningsEscrow;
  }
}
